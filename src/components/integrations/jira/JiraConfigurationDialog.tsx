  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-4xl h-[85vh] max-h-[700px] flex flex-col overflow-hidden">
        ...
        <Tabs defaultValue="settings" className="w-full flex-1 flex flex-col min-h-0 overflow-hidden">
          ...
          <TabsContent value="settings" className="mt-4 flex-1 min-h-0 overflow-hidden">
          ...
          <TabsContent value="activity" className="mt-4 flex-1 min-h-0 overflow-hidden">
            <ScrollArea className="h-full pr-4">
              {projectId ? (
          ...
          {isAdminOrOwner && (
            <TabsContent value="all-projects" className="mt-4 flex-1 min-h-0 overflow-hidden">
              <ScrollArea className="h-full pr-4">
