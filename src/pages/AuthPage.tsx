...
const AuthPage = () => {
  ...
  const eyebrow = isLogin ? "Sign in" : isSignup ? "Create account" : "Reset password";
  const heading = isLogin ? (
    <>Welcome <AccentWord>back.</AccentWord></>
  ) : isSignup ? (
    <>Start with <AccentWord>proof.</AccentWord></>
  ) : (
    <>Forgot your <AccentWord>password?</AccentWord></>
  );
        ...
        <div className="flex items-center py-12 lg:pr-12">
          <div className="w-full max-w-md">
            ...
            {isForgot && resetSent ? (
              ...
              <form onSubmit={handleSubmit} className={`space-y-4 ${isForgot ? "mt-8" : ""}`}>
