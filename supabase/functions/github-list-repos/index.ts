...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const ghUrl = `${GITHUB_API}/user/repos?sort=updated&direction=desc&per_page=100&page=${page}&visibility=all&affiliation=owner,collaborator,organization_member`;
